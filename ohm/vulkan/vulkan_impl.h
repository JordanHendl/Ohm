...
struct Vulkan {
   ...
   */
  struct Memory {
    static auto heaps(int gpu) Ohm_NOEXCEPT -> const std::vector<GpuMemoryHeap>&;
    static auto allocate(int gpu, HeapType type, size_t heap_index, size_t size)
        Ohm_NOEXCEPT -> int32_t;
   ...
   */
  struct Array {
    static auto create(int gpu, size_t num_elmts, size_t elm_size) Ohm_NOEXCEPT -> int32_t;
    static auto destroy(int32_t handle) Ohm_NOEXCEPT -> void;
    static auto required(int32_t handle) Ohm_NOEXCEPT -> size_t;
    static auto bind(int32_t array_handle, int32_t memory_handle) Ohm_NOEXCEPT -> void;
  };
  ...
  struct Commands {
    ...
    static auto copyArray(int32_t handle, int32_t src, int32_t dst, size_t count) Ohm_NOEXCEPT -> void;
    static auto copyArray(int32_t handle, int32_t src, void* dst, size_t count) Ohm_NOEXCEPT -> void;
    static auto copyArray(int32_t handle, const void* src, int32_t dst, size_t count) Ohm_NOEXCEPT -> void;
