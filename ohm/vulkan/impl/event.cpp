...
auto convert(SDL_Event& event) -> ohm::Event {
  ...
  switch (event.type) {
    case SDL_KEYDOWN: {
      lib_event = ohm::Event(ohm::Event::Type::KeyDown,
                             keyFromSDL(event.key.keysym.sym));
      break;
    }
    case SDL_KEYUP: {
      lib_event =
          ohm::Event(ohm::Event::Type::KeyUp, keyFromSDL(event.key.keysym.sym));
      break;
    }
    case SDL_MOUSEBUTTONDOWN: {
      lib_event = ohm::Event(ohm::Event::Type::MouseButtonDown,
                             mouseButtonFromSDL(event.button.button));
      break;
    }
    case SDL_MOUSEBUTTONUP: {
      lib_event = ohm::Event(ohm::Event::Type::MouseButtonUp,
                             mouseButtonFromSDL(event.button.button));
      break;
    }
    case SDL_QUIT: {
...
Event::Event(Event&& mv) { *this = std::move(mv); }
