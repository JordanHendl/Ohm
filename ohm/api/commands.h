...
namespace ohm {
  ...
  class Commands {
    public:
      ...
      auto copy(const Array<API, Type, Allocator>& src, Array<API, Type, Allocator>& dst, size_t count = 0) -> void;
      
      template<typename Type, typename Allocator>
      auto copy(const Type* src, Array<API, Type, Allocator>& dst, size_t count = 0) -> void;
      
      template<typename Type, typename Allocator>
      auto copy(const Array<API, Type, Allocator>& src, Type* dst, size_t count = 0) -> void;
  ...
  template<typename API, QueueType Queue>
  template<typename Type, typename Allocator>
  auto Commands<API, Queue>::copy(const Array<API, Type, Allocator>& src, Array<API, Type, Allocator>& dst, size_t count) -> void {
    API::Commands::copyArray(this->m_handle, src.handle(), dst.handle(), count);
  }
  
  template<typename API, QueueType Queue>
  template<typename Type, typename Allocator>
  auto Commands<API, Queue>::copy(const Array<API, Type, Allocator>& src, Type* dst, size_t count) -> void {
    API::Commands::copyArray(this->m_handle, src.handle(), static_cast<void*>(dst), count);
  }
      
  template<typename API, QueueType Queue>
  template<typename Type, typename Allocator>
  auto Commands<API, Queue>::copy(const Type* src, Array<API, Type, Allocator>& dst, size_t count) -> void {
    API::Commands::copyArray(this->m_handle, static_cast<const void*>(src), dst.handle(), count);
  }
